...
class TestSortByName {
	...
	public void setup() throws Exception {
		...
		this.testEvent1 = new Event(this.testString1, this.startTime1, this.endTime1, defaultString, defaultString,
				attendees, Visibility.PUBLIC);
		this.testEvent2 = new Event(this.testString2, this.startTime1, this.endTime1, defaultString, defaultString,
				attendees, Visibility.PUBLIC);
		this.testEvent3 = new Event(this.testString3, this.startTime1, this.endTime1, defaultString, defaultString,
				attendees, Visibility.PUBLIC);
	...
	void testCollectionWithOneEntry() {
		...
		this.testCalendar.sortByName();
		assertTrue(this.testCalendar.getEvents().get(0).getName().equals(this.testString1));
	}
	...
	void testCollectionWithMultipleEntriesErliestInFirstSlot() {
		...
		this.testCalendar.sortByName();
		boolean firstCheck = this.testCalendar.getEvents().get(0).getName().equals(this.testString1);
		boolean secondCheck = this.testCalendar.getEvents().get(2).getName().equals(this.testString3);
